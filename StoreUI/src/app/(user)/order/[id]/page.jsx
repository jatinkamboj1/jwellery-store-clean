...
import { FaCcVisa, FaShoppingCart } from "react-icons/fa";
...
const Page = () => {
  ...
  const fetchOrders = async () => {
    try {
      ...
      setPaymentMethod(response.paid);
    } catch (error) {}
  };
      ...
      <div className="border-top pt-3">
        ...
        <div className="order-details">
            ...
            {products.length > 0 &&
              products.map((item) => (
                ...
                >
                  <img
                    src={
                      convertS3UrlToLocalPath(item.product.images[0]) ||
                      "https://images.weserv.nl/?url=https://developers.google.com/static/maps/documentation/streetview/images/error-image-generic.png&w=100&h=100"
                    }
                    alt={item.name}
          ...
          <div className="order-summary p-3">
            ...
            <div className="d-flex justify-content-between gap-5">
              <span>Discount</span>
              <span>-${discountedValue.toFixed(2) || 0}</span>
            </div>
      ...
      <div className="py-4 mt-3">
        ...
        <div className="row g-4 justify-content-center mt-1">
          <div className="col-12 col-md-6">
            <div>
              <h5 className="fw-bold">Shipping Method</h5>
